...
(function (factory) {
    ...
    //dom渲染
    domDate = '<div id="date-wrapper"><h3>支付时间</h3><div id="d-content"><div id="d-tit"><div class="t1">年</div><div class="t2">月</div><div class="t3">日</div></div><div id="d-bg"><ol id="d-year"></ol><ol id="d-month"></ol><ol id="d-day"></ol></div></div><a id="d-cancel" href="javascript:">取消</a><a id="d-confirm" href="javascript:">确定</a></div><div id="d-mask"></div>';
    
    if(isEnglish){
        domDate = domDate.replace('支付时间','DatePicker').replace('取消','cancel').replace('确定','confirm');
